...
import main.java.ch05_abstract_interface.oop.model.service.PGJCalculator;
...
//        service.ex1();
        //---------------------------------------------
//        Calculator calculator = new Calculator(); --> 인터페이스는 객체 생성이 안됨
        // 인터페이스 == 미완성 설계도 == 객체 생성 불가능
        // -> 추상클래스처럼 참조 변수로는 사용 가능

       // Calculator cal = new PGJCalculator();
        ...
        // -> 이를 이용하여 공동작업(팀 프로젝트)에 필요한 개발 환경을 조성할 수 있음
