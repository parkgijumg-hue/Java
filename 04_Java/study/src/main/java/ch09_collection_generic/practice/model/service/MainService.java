...
import main.java.ch09_collection_generic.practice.model.service.LoginService;
...
public class MainService {
	...
	private void signUp() {
        ...
        while(true) {
            ...
            System.out.println("중복되는 아이디 입니다.다시 입력하세요.");
        }
	...
	private void login() {
        ...
        // member변수에 id 검색한 값 담기
        Member member = findId(id);

        // id가 없거나 id랑 pw랑 일치하지 않으면 오류 -> 다시 메인메뉴로 돌아감
        if(member == null|| !member.getMemberPw().equals(pw)) {
